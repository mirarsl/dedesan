     ...
     <div class="widget">
      ...
      <div class="recent-post-wrap">
       ...
       <div class="recent-post"> 
        <div class="media-img">
         <a href="{{route('blog',$item->slug)}}"><img src="{{asset($item->image)}}" alt="{{$item->title}}"></a>
        </div>
        <div class="media-body">
         <h4 class="post-title"><a class="text-inherit" href="{{route('blog',$item->slug)}}">{{$item->title}}</a></h4>
        </div>
       </div>
       @endforeach
      </div>
